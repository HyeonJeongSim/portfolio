            ...
            <form name="find" method="post" action="find.php">
                <ul>
                    <li>
                        ...
                        <input type="text" name="name" id="name" requried placeholder="이름을 입력하세요">
                    </li>
                    <li class="hp">
                        ...
                        <input type="text" id="hp2" name="hp2" requried maxlength="4" placeholder="(ex. 1111)">
                        <span>-</span>
                        <label class="hidden" for="hp3">연락처 마지막4자리</label>
                        <input type="text" id="hp3" name="hp3" requried maxlength="4" placeholder="(ex. 1111)">
                    </li>
                </ul>
